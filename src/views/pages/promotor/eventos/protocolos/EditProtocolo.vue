...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .put(`${baseURL}/promotor-protocolo/${router.currentRoute.value.params.idprotocolo}`, values)
        .then((response) => {
            resetForm();
            router.back();
            toast.add({ severity: 'success', summary: `Successo`, detail: 'Protocolo alterado com sucesso', life: 3000 });
        })
        .catch((error) => {
...
const getData = () => {
    axios
    .get(`${baseURL}/promotor-protocolo/${router.currentRoute.value.params.idprotocolo}/edit`)
        .then((response) => {
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário Edição de Protocolos</h5>
