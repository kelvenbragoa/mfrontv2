...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .post(`${baseURL}/promotor-lineups`, values, {
            headers: {
        ...
        .then((response) => {
            resetForm();
            router.back();
            toast.add({ severity: 'success', summary: `Successo`, detail: 'LineUp criado com sucesso', life: 3000 });
        })
        .catch((error) => {
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário Criação de LineUps</h5>
