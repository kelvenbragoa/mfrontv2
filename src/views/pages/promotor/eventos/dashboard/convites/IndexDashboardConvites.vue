...
const getData = async (page = 1) => {
    axios
        .get(`${baseURL}/promotor-dashboard/${router.currentRoute.value.params.id}/convites`, {
            params: {
    ...
    <div class="grid" v-if="!isLoadingDiv" id="print-me" ref="printContent">
            ...
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        ...
                        <div class="text-900 font-medium text-ml">{{ retriviedData.allinvites_total }}</div>
                    </div>
        ...
        <div class="col-12 xl:col-12">
            <div class="card">
                ...
                <DataTable :value="retriviedData.invites_issued" :rows="1" responsiveLayout="scroll">
                    <Column field="name" header="Nome" :sortable="true" style="width: 35%"></Column>
                    <Column field="invite.name" header="Convite" :sortable="true" style="width: 35%"></Column>
                    ...
                    <Column field="created_at" header="Data" :sortable="true" style="width: 35%">
                        <template #body="slotProps">
