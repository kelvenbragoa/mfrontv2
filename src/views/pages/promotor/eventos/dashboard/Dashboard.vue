...
const downloadPDFTickets = () => {
    loadingprint.value = true;

    loadingprint.value = false;

    axios({
        url: `${baseURL}/download-report/${router.currentRoute.value.params.id}/tickets`,
        responseType: 'blob'
    })
        .then((response) => {
            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'ticketreport' + retriviedData.value.id + '.pdf');
            document.body.appendChild(link);
            link.click();
            loadingprint.value = false;
            toast.add({ severity: 'success', summary: `Sucesso`, detail: 'Documento baixado com sucesso', life: 3000 });
    ...
    <div class="grid" v-if="!isLoadingDiv">
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                ...
                <router-link :to="'/promotor/eventos/' + router.currentRoute.value.params.id + '/dashboard/bilhetes'"><i class="pi pi-eye text-blue-500 text-xl"></i></router-link>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                ...
                <router-link :to="'/promotor/eventos/' + router.currentRoute.value.params.id + '/dashboard/pacotes'"><i class="pi pi-eye text-blue-500 text-xl"></i></router-link>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                ...
                <router-link :to="'/promotor/eventos/' + router.currentRoute.value.params.id + '/dashboard/convites'"><i class="pi pi-eye text-blue-500 text-xl"></i></router-link>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                ...
                <router-link :to="'/promotor/eventos/' + router.currentRoute.value.params.id + '/dashboard/lineups'"><i class="pi pi-eye text-blue-500 text-xl"></i></router-link>
            </div>
        </div>
        ...
        <div class="col-12 xl:col-12">
            <div class="card">
                ...
                <Button label="Print" class="mr-2 mb-2" @click="downloadPDFTickets"><i class="pi pi-print"></i> Print</Button>
