...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .put(`${baseURL}/promotor-packages/${router.currentRoute.value.params.idpacotes}`, values)
        .then((response) => {
            resetForm();
            router.back();
            toast.add({ severity: 'success', summary: `Successo`, detail: 'Pacote alterado com sucesso', life: 3000 });
        })
        .catch((error) => {
...
const getData = () => {
    axios
    .get(`${baseURL}/promotor-packages/${router.currentRoute.value.params.idpacotes}/edit`)
        .then((response) => {
            // toast.add({ severity: 'success', summary: 'Success Message', detail: 'Message Detail', life: 3000 });
            retriviedData.value = response.data.package;
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário Criação de Pacotes</h5>
