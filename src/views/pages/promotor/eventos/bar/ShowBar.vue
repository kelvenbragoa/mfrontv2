    ...
    <div className="card" v-if="!isLoadingDiv">
        <div class="col-12">
            ...
            <div class="flex flex-wrap gap-2 mb-3">
                <router-link :to="'/promotor/eventos/' + retriviedData.event_id + '/produtos/create'">
                    <Button label="Criar Produto" class="mr-2 mb-2" icon="pi pi-plus" />
                </router-link>
                <router-link :to="'/promotor/eventos/' + retriviedData.event_id + '/bar/' + retriviedData.id + '/stock/entrada'">
                    <Button label="Nota de entrada" class="mr-2 mb-2" icon="pi pi-plus-circle" severity="success" />
                </router-link>
                <router-link :to="'/promotor/eventos/' + retriviedData.event_id + '/bar/' + retriviedData.id + '/stock/saida'">
                    <Button label="Nota de saída" class="mr-2 mb-2" icon="pi pi-minus-circle" severity="warn" />
                </router-link>
                <router-link :to="'/promotor/eventos/' + retriviedData.event_id + '/bar/' + retriviedData.id + '/stock/transferencia'">
                    <Button label="Transferir" class="mr-2 mb-2" icon="pi pi-arrows-h" severity="info" />
                </router-link>
                <router-link :to="'/promotor/eventos/' + retriviedData.event_id + '/bar/' + retriviedData.id + '/stock/inventario'">
            ...
            <DataTable :value="products" tableStyle="min-width: 50rem">
                ...
                <Column header="Ações">
                    <template #body="slotProps">
                        <router-link :to="'/promotor/eventos/' + retriviedData.event_id + '/produtos/' + slotProps.data.id + '/edit'" class="mr-2"><i class="pi pi-file-edit"></i></router-link>
                        <router-link :to="'/promotor/eventos/' + retriviedData.event_id + '/produtos/' + slotProps.data.id" class="mr-2"><i class="pi pi-eye"></i></router-link>
            ...
            <DataTable :value="stockNotes" tableStyle="min-width: 40rem" class="p-datatable-sm">
                ...
                <Column header="">
                    <template #body="slotProps">
                        <router-link :to="'/promotor/eventos/' + retriviedData.event_id + '/stock/' + slotProps.data.id">
                            <i class="pi pi-eye"></i>
                        </router-link>
                    </template>
                </Column>
