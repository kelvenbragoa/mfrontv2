...
import EventLiveManager from '@/components/live/EventLiveManager.vue';
...
<template>
    <div class="promotor-event-show">
        ...
        <template v-else>
            ...
            <EventLiveManager :event-id="event.id" />
            ...
            <div class="card">
                ...
                <TabView>
                    ...
                    <TabPanel :header="`Loja (${shopProducts.length})`">
                        <div class="tab-toolbar">
                            <router-link :to="`/promotor/eventos/${event.id}/loja/create`">
                        ...
                        <DataTable v-if="shopProducts.length" :value="shopProducts" responsiveLayout="scroll" class="p-datatable-sm">
                            ...
                            <Column header="Ações" style="width: 9rem">
                                <template #body="slotProps">
                                    <div class="flex gap-1">
                                        <router-link :to="`/promotor/eventos/${event.id}/loja/${slotProps.data.id}`">
                                            <Button icon="pi pi-eye" text rounded severity="secondary" v-tooltip.top="'Ver'" />
                                        </router-link>
                                        <router-link :to="`/promotor/eventos/${event.id}/loja/${slotProps.data.id}/edit`">
                                            <Button icon="pi pi-pencil" text rounded severity="secondary" v-tooltip.top="'Editar'" />
                                        </router-link>
                                        <Button
                                            icon="pi pi-trash"
