...
const schema = yup.object({
    ...
    // email: yup.string().required().email().label('Email bar_store_id'),
...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .post(`${baseURL}/promotor-barman`, values, {
            headers: {
        ...
        .then((response) => {
            resetForm();
            router.back();
            toast.add({ severity: 'success', summary: `Successo`, detail: 'Barman criado com sucesso', life: 3000 });
        })
        .catch((error) => {
...
const getCreateBarman = () => {
    axios
        .get(`${baseURL}/auxiliar-event/${router.currentRoute.value.params.id}`)
        .then((response) => {
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário Criação de Barman</h5>
                        ...
                        <div class="field">
                            <label for="bi">Bilhete de Identificação</label>
