...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .put(`${baseURL}/promotor-invites/${router.currentRoute.value.params.idconvites}`, values)
        .then((response) => {
            resetForm();
            router.back();
            toast.add({ severity: 'success', summary: `Successo`, detail: 'Convite alterado com sucesso', life: 3000 });
        })
        .catch((error) => {
...
const getData = () => {
    axios
    .get(`${baseURL}/promotor-invites/${router.currentRoute.value.params.idconvites}/edit`)
        .then((response) => {
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário Edição de Convites</h5>
