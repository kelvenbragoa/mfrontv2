...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .post(`${baseURL}/promotor-protocolo`, values, {
            headers: {
        ...
        .then((response) => {
            resetForm();
            router.back();
            toast.add({ severity: 'success', summary: `Successo`, detail: 'Protocolo criado com sucesso', life: 3000 });
        })
        .catch((error) => {
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário Criação de Protocolo</h5>
