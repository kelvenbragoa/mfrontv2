    ...
    <div className="card" v-if="!isLoadingDiv">
        <div class="col-12">
            ...
            <DataTable :value="retriviedData.data" tableStyle="min-width: 50rem">
                ...
                <Column header="Ações">
                    <template #body="slotProps">
                        <router-link :to="'/admin/eventos/' + slotProps.data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link> | <router-link :to="'/admin/eventos/' + slotProps.data.id"><i class="pi pi-eye"></i></router-link> |
