...
const schema = yup.object({
    ...
    status_id: yup.string().required().trim().label('Status'),
...
const getData = () => {
    axios
        .get(`${baseURL}/promotor-eventos/${router.currentRoute.value.params.id}/edit`)
        .then((response) => {
            ...
            city_id.value = retriviedData.value.city_id;
            status_id.value = retriviedData.value.status_id;
            description.value = retriviedData.value.description;
            main_category_id.value = retriviedData.value.main_category_id;
            second_category_id.value = retriviedData.value.second_category_id;
            type_event_id.value = retriviedData.value.type_event_id;
            address.value = retriviedData.value.address;
            latitude.value = retriviedData.value.latitude ?? '';
            longitude.value = retriviedData.value.longitude ?? '';
            ...
            website.value = retriviedData.value.website;
            instagram.value = retriviedData.value.instagram;
            facebook.value = retriviedData.value.facebook;
            twitter.value = retriviedData.value.twitter;
            youtube.value = retriviedData.value.youtube;
            imagefield.value = retriviedData.value.image;
            _method.value = 'put';
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        ...
                        <div class="field">
                            <label for="youtube">Estado</label>
                            <Dropdown v-model="status_id" :options="statuses" optionLabel="name" optionValue="id" placeholder="Selecionar" :class="{ 'p-invalid': errors.status_id }" />
                        </div>
